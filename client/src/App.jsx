...
const GiftCardOrders = React.lazy(() => import('./pages/GiftCardOrders'))
const AdminGiftProducts = React.lazy(() => import('./pages/AdminGiftProducts'))
      ...
      <div className="app">
        ...
        <main className="main-content">
          ...
          <div className={isAuthenticated ? "container" : ""}>
            ...
            <Route path="/admin/gift-products" element={<ProtectedRoute isAuthenticated={isAuthenticated}><AdminGiftProducts /></ProtectedRoute>} />
            <Route path="/forgot-password" element={<ForgotPassword />} />
            <Route path="/terms" element={<Terms />} />
            <Route path="/privacy" element={<Privacy />} />
            <Route path="/gift-cards" element={<GiftCards user={user} />} />
            <Route path="/gift-card-orders" element={<ProtectedRoute isAuthenticated={isAuthenticated}><GiftCardOrders /></ProtectedRoute>} />
